...
import { addItem, reduceItemCount, removeItem } from '../redux/slices/cartSlice'
...
export const CartItem: React.FC<CartItemProps> = ({ item }) => {
	...
	const handleReduceItemCount = () => {
		dispatch(reduceItemCount(item))
	}
